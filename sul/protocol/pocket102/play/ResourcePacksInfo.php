...
class ResourcePacksInfo extends Packet
{
    ...
    public function __constructor($mustAccept, \sul\protocol\pocket102\types\PackWithSize[] $behaviourPacks, \sul\protocol\pocket102\types\PackWithSize[] $resourcePacks)
    {
