...
class ResourcePacksInfo extends Packet
{
    ...
    public function __constructor($mustAccept, \sul\protocol\bedrock150\types\PackWithSize[] $behaviourPacks, \sul\protocol\bedrock150\types\PackWithSize[] $resourcePacks)
    {
