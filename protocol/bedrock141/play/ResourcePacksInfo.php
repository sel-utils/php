...
class ResourcePacksInfo extends Packet
{
    ...
    public function __constructor($mustAccept, \sul\protocol\bedrock141\types\PackWithSize[] $behaviourPacks, \sul\protocol\bedrock141\types\PackWithSize[] $resourcePacks)
    {
