...
class ResourcePacksInfo extends Packet
{
    ...
    public function __constructor($mustAccept, \sul\protocol\pocket130\types\PackWithSize[] $behaviourPacks, \sul\protocol\pocket130\types\PackWithSize[] $resourcePacks)
    {
