...
class CommandBlockUpdate extends Packet
{
    ...
    public function __constructor($updateBlock, \sul\protocol\bedrock160\types\BlockPosition $position, $mode, $redstoneMode, $conditional, $minecart, $command, $lastOutput, $hover, $trackOutput)
    {
