...
class CommandBlockUpdate extends Packet
{
    ...
    public function __constructor($updateBlock, \sul\protocol\pocket105\types\BlockPosition $position, $mode, $redstoneMode, $conditional, $minecart, $command, $lastOutput, $hover, $trackOutput)
    {
