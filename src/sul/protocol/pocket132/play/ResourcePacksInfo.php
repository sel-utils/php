...
class ResourcePacksInfo extends Packet
{
    ...
    public function __constructor($mustAccept, \sul\protocol\pocket132\types\PackWithSize[] $behaviourPacks, \sul\protocol\pocket132\types\PackWithSize[] $resourcePacks)
    {
