...
class EntityPickRequest extends Packet
{
    ...
    public function __constructor(\sul\protocol\pocket130\types\BlockPosition $blockPosition, $hotbarSlot, $face, $facePosition, $position, $slot, \sul\protocol\pocket130\types\Slot $item)
    {
