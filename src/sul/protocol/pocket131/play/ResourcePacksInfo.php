...
class ResourcePacksInfo extends Packet
{
    ...
    public function __constructor($mustAccept, \sul\protocol\pocket131\types\PackWithSize[] $behaviourPacks, \sul\protocol\pocket131\types\PackWithSize[] $resourcePacks)
    {
